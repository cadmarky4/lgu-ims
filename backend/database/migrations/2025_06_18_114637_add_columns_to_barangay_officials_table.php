...
return new class extends Migration
{
    ...
    public function down(): void
    {
        Schema::table('barangay_officials', function (Blueprint $table) {
            $table->dropColumn([
                'prefix', 'first_name', 'middle_name', 'last_name', 'gender', 'birth_date',
                'contact_number', 'email_address', 'complete_address', 'civil_status', 
                'educational_background', 'position', 'position_title', 'committee_assignment',
                'term_start', 'term_end', 'term_number', 'is_current_term', 'election_date',
                'votes_received', 'is_elected', 'appointment_document', 'status', 'status_date',
                'status_reason', 'work_experience', 'skills_expertise', 'trainings_attended',
                'certifications', 'major_accomplishments', 'projects_initiated', 'performance_notes',
                'performance_rating', 'emergency_contact_name', 'emergency_contact_number',
                'emergency_contact_relationship', 'profile_photo', 'documents', 'oath_taking_date',
                'oath_taking_notes', 'is_active', 'created_by', 'updated_by'
            ]);
        });
    }
};
