...
interface AppointmentModalFooterProps {
  mode: 'view' | 'edit';
  isDirty: boolean;
...
export const AppointmentModalFooter: React.FC<AppointmentModalFooterProps> = ({
  mode,
  isDirty,
  isSubmitting,
  onModeToggle,
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="cursor-pointer inline-flex items-center px-4 py-2 bg-blue-600 text-white hover:bg-blue-700 focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isSubmitting ? (
          <>
