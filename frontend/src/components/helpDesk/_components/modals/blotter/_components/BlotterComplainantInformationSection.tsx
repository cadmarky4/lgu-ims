...
interface BlotterComplainantInformationSectionProps {
  blotter: ViewBlotter;
  mode: 'view' | 'edit';
}

export const BlotterComplainantInformationSection: React.FC<BlotterComplainantInformationSectionProps> = ({
  blotter,
  mode,
}) => {
  const {
        ...
        <div>
          {mode === 'view' ? (
            <div>
              ...
              <p className="text-sm text-gray-900">{blotter.ticket.requester_name}</p>
              {isResident && (
          ...
          {mode === 'view' ? (
            <div>
              ...
              <p className="text-sm text-gray-900 flex items-center gap-2">
                ...
                {blotter.ticket.email_address || 'Not provided'}
              </p>
            </div>
          ) : (
            <FormField
          ...
          {mode === 'view' ? (
            <div>
              ...
              <p className="text-sm text-gray-900 flex items-center gap-2">
                ...
                {blotter.ticket.complete_address}
              </p>
            </div>
          ) : (
            <FormField
