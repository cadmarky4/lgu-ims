...
export const SuggestionSubmitterInformationSection: React.FC<SuggestionSubmitterInformationSectionProps> = ({
  suggestion,
  mode,
}) => {
  const {
  ...
  const isAnonymous = !suggestion.ticket.requester_name || 
                     ...
                     suggestion.ticket.requester_name === 'Anonymous';
    ...
    return (
      <div className="space-y-4">
        ...
        <div className="text-center py-4 text-gray-500 bg-gray-50 rounded-lg">
          ...
          <p className="text-sm">This suggestion was submitted anonymously</p>
        </div>
      </div>
    );
  }
          ...
          {mode === 'view' ? (
            <div>
              ...
              <p className="text-sm text-gray-900 flex items-center gap-2">
                ...
                {suggestion.ticket.contact_number || 'Not provided'}
              </p>
            </div>
          ) : (
            <FormField
          ...
          {mode === 'view' ? (
            <div>
              ...
              <p className="text-sm text-gray-900 flex items-center gap-2">
                ...
                {suggestion.ticket.email_address || 'Not provided'}
              </p>
            </div>
          ) : (
            <FormField
          ...
          {mode === 'view' ? (
            <div>
              ...
              <p className="text-sm text-gray-900 flex items-center gap-2">
                ...
                {suggestion.ticket.complete_address || 'Not provided'}
              </p>
            </div>
          ) : (
            <FormField
