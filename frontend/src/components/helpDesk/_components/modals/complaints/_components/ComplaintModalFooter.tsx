...
interface ComplaintModalFooterProps {
  mode: 'view' | 'edit';
  isDirty: boolean;
...
export const ComplaintModalFooter: React.FC<ComplaintModalFooterProps> = ({
  mode,
  isDirty,
  isSubmitting,
  onModeToggle,
  ...
  return (
    <div className="flex items-center gap-2">
      ...
      <button
        ...
        className="cursor-pointer inline-flex items-center px-4 py-2 bg-orange-600 text-white hover:bg-orange-700 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 rounded-lg text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
      >
        {isSubmitting ? (
          <>
