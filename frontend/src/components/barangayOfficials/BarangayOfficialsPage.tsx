...
const BarangayOfficialsPage: React.FC = () => {
  ...
  const [selectedFilter, setSelectedFilter] = useState('All Active Officials');  const [showEditForm, setShowEditForm] = useState(false);
  ...
  return (
    <main className="p-6 bg-gray-50 min-h-screen flex flex-col gap-4">      {/* Page Header */}
      <div className="mb-2">
