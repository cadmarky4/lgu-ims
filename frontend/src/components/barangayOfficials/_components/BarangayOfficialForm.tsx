...
export const BarangayOfficialForm: React.FC<BarangayOfficialFormProps> = ({
    ...
    return (
        <main className={`p-6 bg-gray-50 min-h-screen flex flex-col gap-4 transition-all duration-500 ease-out 'opacity-100 translate-y-0'`}>
            {/* Breadcrumb */}
            <Breadcrumb isLoaded={true} />
            {/* Header */}
            <div className={`mb-2 transform transition-all duration-500 'translate-y-0 opacity-100'`} style={{ animationDelay: '100ms' }}>
