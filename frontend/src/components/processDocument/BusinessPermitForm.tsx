...
const BusinessPermitForm: React.FC<BusinessPermitFormProps> = ({ onNavigate }) => {
  ...
  const documentForm = useDocumentForm({
    ...
    onSuccess: (document) => {
      console.log('Business permit created successfully:', document);
      setStep(3);
    },
    onError: (error) => {
      console.error('Failed to create business permit:', error);
    }
  });
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex justify-end space-x-4 mt-6">
          ...
          <button
            ...
            disabled={documentForm.isSubmitting || !formData.businessName || !formData.businessType || !formData.businessAddress || !formData.businessDescription || !formData.capitalAmount || !formData.operatingHours || !formData.certifyingOfficial}
