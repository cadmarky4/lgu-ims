...
const CertificateOfResidencyForm: React.FC<CertificateOfResidencyFormProps> = ({ onNavigate }) => {
  ...
  const documentForm = useDocumentForm({
    ...
    onSuccess: (document) => {
      console.log('Certificate of Residency created successfully:', document);
      setStep(3);
    },
    onError: (error) => {
      console.error('Failed to create certificate of residency:', error);
    }
  });
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex justify-end space-x-4 mt-6">
          ...
          <button
            ...
            disabled={documentForm.isSubmitting || !formData.purpose || !formData.yearsOfResidence || !formData.residencyStatus || !formData.certifyingOfficial}
