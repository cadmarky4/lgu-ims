    ...
    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-blue-600">
              Age: {householdHead?.age} | Gender: {householdHead?.gender}
            </p>
          </div>
      ...
      {members.length === 0 ? (
        <div className="text-center py-8">
          <p className="text-gray-600">No household members added yet.</p>
          <p className="text-sm text-gray-500 mt-1">Click "Add Member" to start adding family members.</p>
        </div>
      ) : (
