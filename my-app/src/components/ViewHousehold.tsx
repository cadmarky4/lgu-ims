...
import { type Household } from '../services/types';
...
const ViewHousehold: React.FC<ViewHouseholdProps> = ({ household, onClose }) => {
  // Helper function to get programs
  const getHouseholdPrograms = () => {
    const programs = [];
  ...
  const programs = getHouseholdPrograms();
  const totalMembers = (household.members ? household.members.length : 0) + (household.head_resident ? 1 : 0);
      ...
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        <div className="flex items-center mb-8 pb-6 border-b border-gray-200">
          ...
          <div className="ml-6">
            ...
            <p className="text-sm text-gray-500 mt-1">
              {totalMembers} member{totalMembers !== 1 ? 's' : ''} • {household.ownership_status || 'Not specified'}
            </p>
          </div>
        </div>
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <p className="text-gray-900">{totalMembers} member{totalMembers !== 1 ? 's' : ''}</p>
            </div>
            <div>
        ...
        <section className="mb-8">
          ...
          <div className="mt-4 text-sm text-gray-600">
            Total household size: {totalMembers} member{totalMembers !== 1 ? 's' : ''}
          </div>
        </section>
